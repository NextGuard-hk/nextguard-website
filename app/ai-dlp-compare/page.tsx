...
const SAMPLE_CATEGORIES = [
  ...
  },
  {
    ...
    icon: '\ud83d\udce7',
    description: 'Simulate DLP scanning email Subject, Body, and Attachment content before sending',
    samples: [
      ...
      { name: 'Cloud Storage Shared Link', content: 'Shared Google Drive Link: https://drive.google.com/file/d/1aBcDeFgHiJkLmNoPqRsTuVwXyZ/view\nFile: NextGuard_Customer_Database_Feb2026.xlsx\nShared by: raymond.cheung@nextguard.com\nShared with: external-auditor@pwc.com.hk\n\nFile Contents Preview:\nCustomer ID, Name, HKID, Phone, Credit Card, Contract Value\nCUST-001, Chan Tai Man, E567890(1), +852 9876 5432, 4532 8901 2345 6789, HKD 480,000\nCUST-002, Wong Mei Ling, F234567(8), +852 6543 2109, 5407 1234 5678 9012, HKD 720,000\n\nWARNING: File marked RESTRICTED - sharing with external parties requires CISO approval' },
            { name: 'Email Body - PII in Message', content: 'From: hr@nextguard.com\nTo: external-recruiter@headhunt.com\nSubject: RE: Candidate Reference Check\n\nHi Karen,\n\nAs requested, here are the details for the candidate reference:\n\nCandidate: Wong Mei Ling\nHKID: F234567(8)\nDate of Birth: 15 March 1992\nCurrent Salary: HKD 52,000/month\nBank Account (salary deposit): BOC 012-987654-321\nEmergency Contact: Wong Tai Wai, +852 9123 4567 (Father)\nMedical: Declared mild asthma, no other conditions\n\nPlease keep this information strictly confidential.\n\nBest regards,\nSarah Lam\nHR Manager' },
            { name: 'Email Subject - Sensitive Keywords', content: 'From: cfo@nextguard.com\nTo: legal@external-law-firm.com\nSubject: CONFIDENTIAL - Project Phoenix M&A Term Sheet - USD 12.5M Valuation - DO NOT FORWARD\n\nDear Counsel,\n\nPlease review the attached term sheet at your earliest convenience. We aim to sign by end of March.\n\nRegards,\nRaymond Cheung\nCFO, NextGuard Technology Limited' },
            { name: 'Email Body - Credit Card & Payment', content: 'From: accounting@nextguard.com\nTo: vendor-billing@cloudservice.com\nSubject: Payment for Invoice #INV-2026-0342\n\nHi,\n\nPlease process the following payment details:\n\nCompany: NextGuard Technology Limited\nInvoice Amount: USD 8,500\nPayment Method: Corporate Visa\nCard Number: 4532 8901 2345 6789\nExpiry: 09/28\nCVV: 456\nCardholder: Raymond Cheung\nBilling Address: 18/F, Tower 1, Lippo Centre, 89 Queensway, Hong Kong\n\nPlease confirm once payment is processed.\n\nThanks,\nAccounting Team' },
            { name: 'Email Attachment - Employee Database', content: 'From: raymond.cheung@nextguard.com\nTo: auditor@pwc.com.hk\nSubject: FY2025 Audit - Employee Records\nAttachment: NextGuard_Employee_Master_Feb2026.xlsx\n\n--- Attachment Content Preview ---\nemployee_id,full_name,hkid,email,phone,salary_hkd,bank_account,department\nEMP-101,Chan Tai Man,E567890(1),ctm@nextguard.com,+852 9876 5432,45000,HSBC 400-123456-001,Engineering\nEMP-102,Wong Mei Ling,F234567(8),wml@nextguard.com,+852 6543 2109,52000,BOC 012-987654-321,Marketing\nEMP-103,Lee Ka Fai,G345678(9),lkf@nextguard.com,+852 8765 4321,38000,SCB 123-456789-012,Operations\nEMP-104,Ng Siu Hong,H456789(0),nsh@nextguard.com,+852 7654 3210,65000,HSBC 400-654321-002,Security' },
            { name: 'Email Body - Obfuscated PII', content: 'From: suspicious.user@nextguard.com\nTo: personal@gmail.com\nSubject: Notes from today\n\nHey,\n\nJust saving some info:\n\nThe W0ng acc0unt - her !D is F-two-three-four-five-six-seven-(eight)\nSalary info: fifty-two-k per month\nBank deets: B-O-C zero-one-two dash nine-eight-seven-six-five-four dash three-two-one\nHer card: four-five-three-two 89O1 2345 6789 exp oh-nine-twenty-eight\n\nDon\'t forget to delete this after.' },
            { name: 'Email - Clean Business Update', content: 'From: james.wong@nextguard.com\nTo: all-staff@nextguard.com\nSubject: Q1 2026 Company Update\n\nDear Team,\n\nI am pleased to share our Q1 2026 highlights:\n\n- Revenue grew 18% YoY, exceeding our target by 8%\n- We onboarded 15 new enterprise clients across APAC\n- Customer satisfaction score reached 4.7/5.0\n- R&D team shipped 3 major product releases\n- Team expanded to 45 members across HK and Singapore\n\nThank you all for your hard work!\n\nBest regards,\nJames Wong\nCEO, NextGuard Technology Limited' },
            { name: 'Email Attachment - Financial Report', content: 'From: cfo@nextguard.com\nTo: board@nextguard.com\nSubject: Board Pack - Q4 2025 Financial Results\nAttachment: NextGuard_Q4_2025_Board_Pack.pdf\n\n--- Attachment Content Preview ---\nSTRICTLY CONFIDENTIAL - BOARD EYES ONLY\n\nNextGuard Technology Limited\nQ4 2025 Financial Summary\n\nRevenue: HKD 12,300,000 (Target: HKD 10,000,000)\nEBITDA: HKD 2,878,200 (Margin: 23.4%)\nNet Profit: HKD 1,845,000\n\nBank Balances:\n- HSBC Operating: 612-345678-901 - HKD 4,250,000\n- DBS Reserve: 003-456789-012 - HKD 8,100,000\n\nKey Receivables:\n- AIA Hong Kong: HKD 875,000 (contact: Grace Chu, grace.chu@aia.com, +852 3919 3919)\n- Cathay Pacific: HKD 420,000 (contact: David Lam, HKID: N678901(2))\n\nCFO: Raymond Cheung, HKID P567890(1)' },
    ],
  },
]
